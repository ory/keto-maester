...
// ORYAccessControlPolicyRoleReconciler reconciles a ORYAccessControlPolicyRole object
type ORYAccessControlPolicyRoleReconciler struct {
...
func (r *ORYAccessControlPolicyRoleReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
	ctx := context.Background()
	_ = r.Log.WithValues("oryaccesscontrolpolicy", req.NamespacedName)

	var oryPolicy ketov1alpha1.ORYAccessControlPolicyRole
	...
	if oryPolicy.ObjectMeta.DeletionTimestamp.IsZero() {
		...
		if containsString(oryPolicy.ObjectMeta.Finalizers, FinalizerName) {
			...
			if err := ketoClient.DeleteORYAccessControlPolicyRole(oryPolicy.Spec.Flavor, req.NamespacedName.Name); err != nil {
	...
	if oryPolicy.Generation != oryPolicy.Status.ObservedGeneration {
		...
		if _, err := ketoClient.PutORYAccessControlPolicyRole(oryPolicy.Spec.Flavor, oryPolicy.ToORYAccessControlPolicyRoleJSON()); err != nil {
...
func (r *ORYAccessControlPolicyRoleReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&ketov1alpha1.ORYAccessControlPolicyRole{}).
		Complete(r)
}

func (r *ORYAccessControlPolicyRoleReconciler) updateReconciliationStatusError(ctx context.Context, c *ketov1alpha1.ORYAccessControlPolicyRole, code ketov1alpha1.StatusCode, err error) error {
...
func (r *ORYAccessControlPolicyRoleReconciler) ensureEmptyStatusError(ctx context.Context, c *ketov1alpha1.ORYAccessControlPolicyRole) error {
	c.Status.ReconciliationError = ketov1alpha1.ReconciliationError{}
	return r.updatePolicyStatus(ctx, c)
}

func (r *ORYAccessControlPolicyRoleReconciler) updatePolicyStatus(ctx context.Context, c *ketov1alpha1.ORYAccessControlPolicyRole) error {
...
func (r *ORYAccessControlPolicyRoleReconciler) getKetoClientForClient(oryPolicy KetoConfiger) (KetoClientInterface, error) {
